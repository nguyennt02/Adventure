...
[CreateAssetMenu(fileName = "CharacterParameter", menuName = "SO/Character Parameter", order = 1)]
public class CharacterParameter : ScriptableObject
{
    ...
    [Header("JUMP WALL")]
    public float JumpWallPower;
    public float TimeJumpWall;

    [Header("HOLD")]
    public float MaxSpeedWallSlide;
    public float MinSpeedWallSlide;
    public float TimeSlide;
    public float RecoveryRate;
    public float SpeedClimbwall;

    [Header("DASH")]
    public bool CanDash;
    public float TimeDash;
    public float DashPower;
    public int NumberOfAerialDash;
}
